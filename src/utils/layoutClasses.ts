...
export const cardLiftClass =
  'hover:-translate-y-[0.3125rem] hover:border-primary-600 hover:shadow-card'
...
export const portfolioCardClass = `${cardClass} portfolio-item-inner group mx-auto min-h-[23rem] max-w-full overflow-hidden hover:-translate-y-[0.3125rem] hover:border-primary-600 hover:shadow-card-hover`
...
export const imgCardThumbClass =
  'mx-auto block h-full w-full max-w-full object-cover transition-transform duration-200 ease-in-out group-hover:scale-105'
